...
Plugin API major versions are strict. Depviz 0.8 release candidates use Plugin API `2.0`. A v1 plugin is rejected during registration because the driver/verifier identity contract changed.
